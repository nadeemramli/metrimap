...
export const projectsCreateManyUsers_projects_created_byTousersInputObjectSchema: z.ZodType<Prisma.projectsCreateManyUsers_projects_created_byTousersInput, Prisma.projectsCreateManyUsers_projects_created_byTousersInput> = z.object({
...
export const projectsCreateManyUsers_projects_created_byTousersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
