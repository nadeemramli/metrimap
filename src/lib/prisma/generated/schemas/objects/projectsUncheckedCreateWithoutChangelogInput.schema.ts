...
export const projectsUncheckedCreateWithoutChangelogInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutChangelogInput, Prisma.projectsUncheckedCreateWithoutChangelogInput> = z.object({
...
export const projectsUncheckedCreateWithoutChangelogInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
