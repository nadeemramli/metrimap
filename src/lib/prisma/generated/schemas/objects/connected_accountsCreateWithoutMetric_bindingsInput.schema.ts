...
export const connected_accountsCreateWithoutMetric_bindingsInputObjectSchema: z.ZodType<Prisma.connected_accountsCreateWithoutMetric_bindingsInput, Prisma.connected_accountsCreateWithoutMetric_bindingsInput> = z.object({
...
export const connected_accountsCreateWithoutMetric_bindingsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  connector_id: z.string(),
