...
export const metric_cardsCreateWithoutEvidence_itemsInputObjectSchema: z.ZodType<Prisma.metric_cardsCreateWithoutEvidence_itemsInput, Prisma.metric_cardsCreateWithoutEvidence_itemsInput> = z.object({
...
export const metric_cardsCreateWithoutEvidence_itemsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  title: z.string(),
  description: z.string().optional().nullable(),
  category: z.string(),
