...
export const metric_bindingsUncheckedUpdateManyWithoutConnected_accountsInputObjectSchema: z.ZodType<Prisma.metric_bindingsUncheckedUpdateManyWithoutConnected_accountsInput, Prisma.metric_bindingsUncheckedUpdateManyWithoutConnected_accountsInput> = z.object({
...
export const metric_bindingsUncheckedUpdateManyWithoutConnected_accountsInputObjectZodSchema = z.object({
  created_by: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  workspace_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  connector_id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  stream: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
