...
export const projectsCreateWithoutCanvas_snapshotsInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutCanvas_snapshotsInput, Prisma.projectsCreateWithoutCanvas_snapshotsInput> = z.object({
...
export const projectsCreateWithoutCanvas_snapshotsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
