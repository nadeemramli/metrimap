...
export const project_collaboratorsUncheckedUpdateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.project_collaboratorsUncheckedUpdateWithoutProjectsInput, Prisma.project_collaboratorsUncheckedUpdateWithoutProjectsInput> = z.object({
...
export const project_collaboratorsUncheckedUpdateWithoutProjectsInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  user_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  role: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  permissions: z.union([z.lazy(() => project_collaboratorsUpdatepermissionsInputObjectSchema), z.string().array()]).optional(),
