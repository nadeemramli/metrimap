...
export const relationshipsUncheckedCreateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.relationshipsUncheckedCreateWithoutProjectsInput, Prisma.relationshipsUncheckedCreateWithoutProjectsInput> = z.object({
...
export const relationshipsUncheckedCreateWithoutProjectsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  source_id: z.string().optional().nullable(),
  target_id: z.string().optional().nullable(),
  type: z.string(),
