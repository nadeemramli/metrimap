...
export const metric_cardsCreateNestedOneWithoutRelationships_relationships_target_idTometric_cardsInputObjectSchema: z.ZodType<Prisma.metric_cardsCreateNestedOneWithoutRelationships_relationships_target_idTometric_cardsInput, Prisma.metric_cardsCreateNestedOneWithoutRelationships_relationships_target_idTometric_cardsInput> = z.object({
...
export const metric_cardsCreateNestedOneWithoutRelationships_relationships_target_idTometric_cardsInputObjectZodSchema = z.object({
  create: z.union([z.lazy(() => metric_cardsCreateWithoutRelationships_relationships_target_idTometric_cardsInputObjectSchema), z.lazy(() => metric_cardsUncheckedCreateWithoutRelationships_relationships_target_idTometric_cardsInputObjectSchema)]).optional(),
  connectOrCreate: z.lazy(() => metric_cardsCreateOrConnectWithoutRelationships_relationships_target_idTometric_cardsInputObjectSchema).optional(),
  connect: z.lazy(() => metric_cardsWhereUniqueInputObjectSchema).optional()
}).strict();
