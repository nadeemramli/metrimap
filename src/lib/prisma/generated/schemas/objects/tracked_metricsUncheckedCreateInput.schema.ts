...
export const tracked_metricsUncheckedCreateInputObjectSchema: z.ZodType<Prisma.tracked_metricsUncheckedCreateInput, Prisma.tracked_metricsUncheckedCreateInput> = z.object({
...
export const tracked_metricsUncheckedCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  name: z.string(),
  unit: z.string().optional().nullable(),
