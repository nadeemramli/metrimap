...
export const project_collaboratorsUncheckedCreateInputObjectSchema: z.ZodType<Prisma.project_collaboratorsUncheckedCreateInput, Prisma.project_collaboratorsUncheckedCreateInput> = z.object({
...
export const project_collaboratorsUncheckedCreateInputObjectZodSchema = z.object({
  project_id: z.string().optional().nullable(),
  user_id: z.string().optional().nullable(),
  role: z.string().optional(),
  permissions: z.union([z.lazy(() => project_collaboratorsCreatepermissionsInputObjectSchema), z.string().array()]).optional(),
