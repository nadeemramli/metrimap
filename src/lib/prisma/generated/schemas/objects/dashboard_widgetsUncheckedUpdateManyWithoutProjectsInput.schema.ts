...
export const dashboard_widgetsUncheckedUpdateManyWithoutProjectsInputObjectSchema: z.ZodType<Prisma.dashboard_widgetsUncheckedUpdateManyWithoutProjectsInput, Prisma.dashboard_widgetsUncheckedUpdateManyWithoutProjectsInput> = z.object({
...
export const dashboard_widgetsUncheckedUpdateManyWithoutProjectsInputObjectZodSchema = z.object({
  title: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  widget_type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  config: z.union([JsonNullValueInputSchema, jsonSchema]).optional(),
  layout: z.union([JsonNullValueInputSchema, jsonSchema]).optional(),
