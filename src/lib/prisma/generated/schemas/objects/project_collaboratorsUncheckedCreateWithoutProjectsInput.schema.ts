...
export const project_collaboratorsUncheckedCreateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.project_collaboratorsUncheckedCreateWithoutProjectsInput, Prisma.project_collaboratorsUncheckedCreateWithoutProjectsInput> = z.object({
...
export const project_collaboratorsUncheckedCreateWithoutProjectsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  user_id: z.string().optional().nullable(),
  role: z.string().optional(),
  permissions: z.union([z.lazy(() => project_collaboratorsCreatepermissionsInputObjectSchema), z.string().array()]).optional(),
