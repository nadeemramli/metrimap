...
export const workspace_groupsUncheckedCreateInputObjectSchema: z.ZodType<Prisma.workspace_groupsUncheckedCreateInput, Prisma.workspace_groupsUncheckedCreateInput> = z.object({
...
export const workspace_groupsUncheckedCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  workspace_id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
