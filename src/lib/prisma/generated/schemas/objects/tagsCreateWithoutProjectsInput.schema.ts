...
export const tagsCreateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.tagsCreateWithoutProjectsInput, Prisma.tagsCreateWithoutProjectsInput> = z.object({
...
export const tagsCreateWithoutProjectsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  color: z.string().optional().nullable(),
  description: z.string().optional().nullable(),
