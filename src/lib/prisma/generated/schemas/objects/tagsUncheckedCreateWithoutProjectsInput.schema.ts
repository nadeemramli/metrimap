...
export const tagsUncheckedCreateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.tagsUncheckedCreateWithoutProjectsInput, Prisma.tagsUncheckedCreateWithoutProjectsInput> = z.object({
...
export const tagsUncheckedCreateWithoutProjectsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  color: z.string().optional().nullable(),
  description: z.string().optional().nullable(),
