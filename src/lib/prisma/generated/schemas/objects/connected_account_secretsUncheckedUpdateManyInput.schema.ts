...
export const connected_account_secretsUncheckedUpdateManyInputObjectSchema: z.ZodType<Prisma.connected_account_secretsUncheckedUpdateManyInput, Prisma.connected_account_secretsUncheckedUpdateManyInput> = z.object({
  account_id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
...
export const connected_account_secretsUncheckedUpdateManyInputObjectZodSchema = z.object({
  account_id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  access_token: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  refresh_token: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  api_key: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
