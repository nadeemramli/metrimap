...
export const usersCreateWithoutEvidence_items_evidence_items_owner_idTousersInputObjectSchema: z.ZodType<Prisma.usersCreateWithoutEvidence_items_evidence_items_owner_idTousersInput, Prisma.usersCreateWithoutEvidence_items_evidence_items_owner_idTousersInput> = z.object({
...
export const usersCreateWithoutEvidence_items_evidence_items_owner_idTousersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  name: z.string(),
  avatar_url: z.string().optional().nullable(),
