...
export const canvas_snapshotsUncheckedUpdateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.canvas_snapshotsUncheckedUpdateWithoutProjectsInput, Prisma.canvas_snapshotsUncheckedUpdateWithoutProjectsInput> = z.object({
...
export const canvas_snapshotsUncheckedUpdateWithoutProjectsInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  version: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  title: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
