...
export const commentsUncheckedCreateWithoutCommentsInputObjectSchema: z.ZodType<Prisma.commentsUncheckedCreateWithoutCommentsInput, Prisma.commentsUncheckedCreateWithoutCommentsInput> = z.object({
...
export const commentsUncheckedCreateWithoutCommentsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  thread_id: z.string(),
  author_id: z.string().optional().nullable(),
  content: z.string(),
