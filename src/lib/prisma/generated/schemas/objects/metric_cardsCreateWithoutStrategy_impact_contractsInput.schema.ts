...
export const metric_cardsCreateWithoutStrategy_impact_contractsInputObjectSchema: z.ZodType<Prisma.metric_cardsCreateWithoutStrategy_impact_contractsInput, Prisma.metric_cardsCreateWithoutStrategy_impact_contractsInput> = z.object({
...
export const metric_cardsCreateWithoutStrategy_impact_contractsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  title: z.string(),
  description: z.string().optional().nullable(),
  category: z.string(),
