...
import { changelogUncheckedUpdateManyWithoutProjectsNestedInputObjectSchema } from './changelogUncheckedUpdateManyWithoutProjectsNestedInput.schema';
...
export const projectsUncheckedUpdateWithoutUsers_projects_last_modified_byTousersInputObjectSchema: z.ZodType<Prisma.projectsUncheckedUpdateWithoutUsers_projects_last_modified_byTousersInput, Prisma.projectsUncheckedUpdateWithoutUsers_projects_last_modified_byTousersInput> = z.object({
  ...
  changelog: z.lazy(() => changelogUncheckedUpdateManyWithoutProjectsNestedInputObjectSchema).optional(),
...
export const projectsUncheckedUpdateWithoutUsers_projects_last_modified_byTousersInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  tags: z.union([z.lazy(() => projectsUpdatetagsInputObjectSchema), z.string().array()]).optional(),
