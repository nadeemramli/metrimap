...
export const metric_cardsCreateWithoutMetric_card_tagsInputObjectSchema: z.ZodType<Prisma.metric_cardsCreateWithoutMetric_card_tagsInput, Prisma.metric_cardsCreateWithoutMetric_card_tagsInput> = z.object({
...
export const metric_cardsCreateWithoutMetric_card_tagsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  title: z.string(),
  description: z.string().optional().nullable(),
  category: z.string(),
