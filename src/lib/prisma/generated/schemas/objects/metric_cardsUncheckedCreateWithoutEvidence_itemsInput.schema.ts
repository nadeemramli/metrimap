...
export const metric_cardsUncheckedCreateWithoutEvidence_itemsInputObjectSchema: z.ZodType<Prisma.metric_cardsUncheckedCreateWithoutEvidence_itemsInput, Prisma.metric_cardsUncheckedCreateWithoutEvidence_itemsInput> = z.object({
...
export const metric_cardsUncheckedCreateWithoutEvidence_itemsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  title: z.string(),
  description: z.string().optional().nullable(),
