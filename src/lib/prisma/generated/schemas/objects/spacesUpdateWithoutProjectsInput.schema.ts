...
export const spacesUpdateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.spacesUpdateWithoutProjectsInput, Prisma.spacesUpdateWithoutProjectsInput> = z.object({
...
export const spacesUpdateWithoutProjectsInputObjectZodSchema = z.object({
  created_by: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  color: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  sort_order: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
