...
export const evidence_itemsUncheckedUpdateManyWithoutUsers_evidence_items_owner_idTousersInputObjectSchema: z.ZodType<Prisma.evidence_itemsUncheckedUpdateManyWithoutUsers_evidence_items_owner_idTousersInput, Prisma.evidence_itemsUncheckedUpdateManyWithoutUsers_evidence_items_owner_idTousersInput> = z.object({
...
export const evidence_itemsUncheckedUpdateManyWithoutUsers_evidence_items_owner_idTousersInputObjectZodSchema = z.object({
  relationship_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  title: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  date: z.union([z.union([z.date(), z.string().datetime()]), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),
