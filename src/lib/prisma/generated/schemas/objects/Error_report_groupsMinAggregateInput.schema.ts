...
export const Error_report_groupsMinAggregateInputObjectSchema: z.ZodType<Prisma.Error_report_groupsMinAggregateInputType, Prisma.Error_report_groupsMinAggregateInputType> = z.object({
...
export const Error_report_groupsMinAggregateInputObjectZodSchema = z.object({
  fingerprint: z.literal(true).optional(),
  title: z.literal(true).optional(),
  first_seen_at: z.literal(true).optional(),
  last_seen_at: z.literal(true).optional(),
