...
export const relationshipsUpdateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectSchema: z.ZodType<Prisma.relationshipsUpdateWithoutMetric_cards_relationships_target_idTometric_cardsInput, Prisma.relationshipsUpdateWithoutMetric_cards_relationships_target_idTometric_cardsInput> = z.object({
...
export const relationshipsUpdateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectZodSchema = z.object({
  type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  confidence: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  weight: z.union([z.number(), z.lazy(() => NullableFloatFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  created_at: z.union([z.union([z.date(), z.string().datetime()]), z.lazy(() => NullableDateTimeFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
