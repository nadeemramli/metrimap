...
export const event_definitionsCreateOrConnectWithoutTracked_metricsInputObjectSchema: z.ZodType<Prisma.event_definitionsCreateOrConnectWithoutTracked_metricsInput, Prisma.event_definitionsCreateOrConnectWithoutTracked_metricsInput> = z.object({
...
export const event_definitionsCreateOrConnectWithoutTracked_metricsInputObjectZodSchema = z.object({
  where: z.lazy(() => event_definitionsWhereUniqueInputObjectSchema),
  create: z.union([z.lazy(() => event_definitionsCreateWithoutTracked_metricsInputObjectSchema), z.lazy(() => event_definitionsUncheckedCreateWithoutTracked_metricsInputObjectSchema)])
}).strict();
