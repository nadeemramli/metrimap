...
export const connector_runsUncheckedCreateInputObjectSchema: z.ZodType<Prisma.connector_runsUncheckedCreateInput, Prisma.connector_runsUncheckedCreateInput> = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  connected_account_id: z.string().optional().nullable(),
...
export const connector_runsUncheckedCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  connected_account_id: z.string().optional().nullable(),
