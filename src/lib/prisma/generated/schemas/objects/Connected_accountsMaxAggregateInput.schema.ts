...
export const Connected_accountsMaxAggregateInputObjectSchema: z.ZodType<Prisma.Connected_accountsMaxAggregateInputType, Prisma.Connected_accountsMaxAggregateInputType> = z.object({
...
export const Connected_accountsMaxAggregateInputObjectZodSchema = z.object({
  id: z.literal(true).optional(),
  created_by: z.literal(true).optional(),
  workspace_id: z.literal(true).optional(),
  connector_id: z.literal(true).optional(),
