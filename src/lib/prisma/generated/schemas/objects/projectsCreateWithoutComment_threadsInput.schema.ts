...
export const projectsCreateWithoutComment_threadsInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutComment_threadsInput, Prisma.projectsCreateWithoutComment_threadsInput> = z.object({
...
export const projectsCreateWithoutComment_threadsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
