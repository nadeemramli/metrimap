...
export const error_report_groupsCreateInputObjectSchema: z.ZodType<Prisma.error_report_groupsCreateInput, Prisma.error_report_groupsCreateInput> = z.object({
...
export const error_report_groupsCreateInputObjectZodSchema = z.object({
  fingerprint: z.string(),
  title: z.string().optional().nullable(),
  first_seen_at: z.union([z.date(), z.string().datetime()]).optional(),
  last_seen_at: z.union([z.date(), z.string().datetime()]).optional(),
