...
export const usersUncheckedCreateWithoutEvidence_items_evidence_items_owner_idTousersInputObjectSchema: z.ZodType<Prisma.usersUncheckedCreateWithoutEvidence_items_evidence_items_owner_idTousersInput, Prisma.usersUncheckedCreateWithoutEvidence_items_evidence_items_owner_idTousersInput> = z.object({
...
export const usersUncheckedCreateWithoutEvidence_items_evidence_items_owner_idTousersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  name: z.string(),
  avatar_url: z.string().optional().nullable(),
