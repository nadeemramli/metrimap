...
export const canvas_snapshotsCreateManyInputObjectSchema: z.ZodType<Prisma.canvas_snapshotsCreateManyInput, Prisma.canvas_snapshotsCreateManyInput> = z.object({
...
export const canvas_snapshotsCreateManyInputObjectZodSchema = z.object({
  id: z.string().optional(),
  canvas_id: z.string(),
  version: z.number().int(),
  title: z.string(),
