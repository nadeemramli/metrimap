...
export const usersCreateWithoutRelationshipsInputObjectSchema: z.ZodType<Prisma.usersCreateWithoutRelationshipsInput, Prisma.usersCreateWithoutRelationshipsInput> = z.object({
...
export const usersCreateWithoutRelationshipsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  name: z.string(),
  avatar_url: z.string().optional().nullable(),
