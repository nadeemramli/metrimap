...
export const connector_runsUncheckedCreateWithoutConnected_accountsInputObjectSchema: z.ZodType<Prisma.connector_runsUncheckedCreateWithoutConnected_accountsInput, Prisma.connector_runsUncheckedCreateWithoutConnected_accountsInput> = z.object({
...
export const connector_runsUncheckedCreateWithoutConnected_accountsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  connector_id: z.string(),
