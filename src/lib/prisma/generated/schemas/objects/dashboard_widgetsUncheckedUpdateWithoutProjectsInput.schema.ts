...
export const dashboard_widgetsUncheckedUpdateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.dashboard_widgetsUncheckedUpdateWithoutProjectsInput, Prisma.dashboard_widgetsUncheckedUpdateWithoutProjectsInput> = z.object({
...
export const dashboard_widgetsUncheckedUpdateWithoutProjectsInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  title: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  widget_type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  config: z.union([JsonNullValueInputSchema, jsonSchema]).optional(),
