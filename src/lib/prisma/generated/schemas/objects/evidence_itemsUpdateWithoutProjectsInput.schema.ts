...
export const evidence_itemsUpdateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.evidence_itemsUpdateWithoutProjectsInput, Prisma.evidence_itemsUpdateWithoutProjectsInput> = z.object({
...
export const evidence_itemsUpdateWithoutProjectsInputObjectZodSchema = z.object({
  title: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  date: z.union([z.union([z.date(), z.string().datetime()]), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),
  link: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
