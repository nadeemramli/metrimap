...
export const metric_bindingsUncheckedUpdateManyWithoutTracked_metricsInputObjectSchema: z.ZodType<Prisma.metric_bindingsUncheckedUpdateManyWithoutTracked_metricsInput, Prisma.metric_bindingsUncheckedUpdateManyWithoutTracked_metricsInput> = z.object({
...
export const metric_bindingsUncheckedUpdateManyWithoutTracked_metricsInputObjectZodSchema = z.object({
  created_by: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  workspace_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  connected_account_id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  connector_id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
