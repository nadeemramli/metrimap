...
export const strategy_impact_contractsCreateInputObjectSchema: z.ZodType<Prisma.strategy_impact_contractsCreateInput, Prisma.strategy_impact_contractsCreateInput> = z.object({
...
export const strategy_impact_contractsCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  expected_direction: z.string().optional().nullable(),
  expected_delta_value: z.number().optional().nullable(),
