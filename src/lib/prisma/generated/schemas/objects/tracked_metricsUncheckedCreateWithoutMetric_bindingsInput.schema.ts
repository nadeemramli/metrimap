...
export const tracked_metricsUncheckedCreateWithoutMetric_bindingsInputObjectSchema: z.ZodType<Prisma.tracked_metricsUncheckedCreateWithoutMetric_bindingsInput, Prisma.tracked_metricsUncheckedCreateWithoutMetric_bindingsInput> = z.object({
...
export const tracked_metricsUncheckedCreateWithoutMetric_bindingsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  name: z.string(),
  unit: z.string().optional().nullable(),
