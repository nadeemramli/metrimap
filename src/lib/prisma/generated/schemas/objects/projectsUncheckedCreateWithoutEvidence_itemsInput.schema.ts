...
export const projectsUncheckedCreateWithoutEvidence_itemsInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutEvidence_itemsInput, Prisma.projectsUncheckedCreateWithoutEvidence_itemsInput> = z.object({
...
export const projectsUncheckedCreateWithoutEvidence_itemsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
