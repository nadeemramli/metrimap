...
export const node_access_grantsCreateOrConnectWithoutMetric_cardsInputObjectSchema: z.ZodType<Prisma.node_access_grantsCreateOrConnectWithoutMetric_cardsInput, Prisma.node_access_grantsCreateOrConnectWithoutMetric_cardsInput> = z.object({
...
export const node_access_grantsCreateOrConnectWithoutMetric_cardsInputObjectZodSchema = z.object({
  where: z.lazy(() => node_access_grantsWhereUniqueInputObjectSchema),
  create: z.union([z.lazy(() => node_access_grantsCreateWithoutMetric_cardsInputObjectSchema), z.lazy(() => node_access_grantsUncheckedCreateWithoutMetric_cardsInputObjectSchema)])
}).strict();
