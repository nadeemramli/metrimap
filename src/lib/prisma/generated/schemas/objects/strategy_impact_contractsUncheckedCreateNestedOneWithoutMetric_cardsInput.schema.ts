...
export const strategy_impact_contractsUncheckedCreateNestedOneWithoutMetric_cardsInputObjectSchema: z.ZodType<Prisma.strategy_impact_contractsUncheckedCreateNestedOneWithoutMetric_cardsInput, Prisma.strategy_impact_contractsUncheckedCreateNestedOneWithoutMetric_cardsInput> = z.object({
...
export const strategy_impact_contractsUncheckedCreateNestedOneWithoutMetric_cardsInputObjectZodSchema = z.object({
  create: z.union([z.lazy(() => strategy_impact_contractsCreateWithoutMetric_cardsInputObjectSchema), z.lazy(() => strategy_impact_contractsUncheckedCreateWithoutMetric_cardsInputObjectSchema)]).optional(),
  connectOrCreate: z.lazy(() => strategy_impact_contractsCreateOrConnectWithoutMetric_cardsInputObjectSchema).optional(),
  connect: z.lazy(() => strategy_impact_contractsWhereUniqueInputObjectSchema).optional()
}).strict();
