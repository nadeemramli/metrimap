...
export const projectsUncheckedCreateWithoutSpacesInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutSpacesInput, Prisma.projectsUncheckedCreateWithoutSpacesInput> = z.object({
...
export const projectsUncheckedCreateWithoutSpacesInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
