...
export const metric_cardsUncheckedCreateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema: z.ZodType<Prisma.metric_cardsUncheckedCreateWithoutRelationships_relationships_source_idTometric_cardsInput, Prisma.metric_cardsUncheckedCreateWithoutRelationships_relationships_source_idTometric_cardsInput> = z.object({
...
export const metric_cardsUncheckedCreateWithoutRelationships_relationships_source_idTometric_cardsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  title: z.string(),
  description: z.string().optional().nullable(),
