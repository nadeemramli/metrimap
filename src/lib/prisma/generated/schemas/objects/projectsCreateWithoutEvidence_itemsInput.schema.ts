...
export const projectsCreateWithoutEvidence_itemsInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutEvidence_itemsInput, Prisma.projectsCreateWithoutEvidence_itemsInput> = z.object({
...
export const projectsCreateWithoutEvidence_itemsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
