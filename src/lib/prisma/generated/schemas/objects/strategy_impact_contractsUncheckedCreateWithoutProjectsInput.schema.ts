...
export const strategy_impact_contractsUncheckedCreateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.strategy_impact_contractsUncheckedCreateWithoutProjectsInput, Prisma.strategy_impact_contractsUncheckedCreateWithoutProjectsInput> = z.object({
...
export const strategy_impact_contractsUncheckedCreateWithoutProjectsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  strategy_node_id: z.string(),
  expected_direction: z.string().optional().nullable(),
