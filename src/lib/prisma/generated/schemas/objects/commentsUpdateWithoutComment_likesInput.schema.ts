...
export const commentsUpdateWithoutComment_likesInputObjectSchema: z.ZodType<Prisma.commentsUpdateWithoutComment_likesInput, Prisma.commentsUpdateWithoutComment_likesInput> = z.object({
...
export const commentsUpdateWithoutComment_likesInputObjectZodSchema = z.object({
  author_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  content: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  resolved: z.union([z.boolean(), z.lazy(() => BoolFieldUpdateOperationsInputObjectSchema)]).optional(),
  created_at: z.union([z.union([z.date(), z.string().datetime()]), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),
