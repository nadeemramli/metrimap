...
export const usersUncheckedCreateWithoutChangelogInputObjectSchema: z.ZodType<Prisma.usersUncheckedCreateWithoutChangelogInput, Prisma.usersUncheckedCreateWithoutChangelogInput> = z.object({
...
export const usersUncheckedCreateWithoutChangelogInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  name: z.string(),
  avatar_url: z.string().optional().nullable(),
