...
export const source_connection_secretsUncheckedCreateNestedOneWithoutSource_connectionsInputObjectSchema: z.ZodType<Prisma.source_connection_secretsUncheckedCreateNestedOneWithoutSource_connectionsInput, Prisma.source_connection_secretsUncheckedCreateNestedOneWithoutSource_connectionsInput> = z.object({
...
export const source_connection_secretsUncheckedCreateNestedOneWithoutSource_connectionsInputObjectZodSchema = z.object({
  create: z.union([z.lazy(() => source_connection_secretsCreateWithoutSource_connectionsInputObjectSchema), z.lazy(() => source_connection_secretsUncheckedCreateWithoutSource_connectionsInputObjectSchema)]).optional(),
  connectOrCreate: z.lazy(() => source_connection_secretsCreateOrConnectWithoutSource_connectionsInputObjectSchema).optional(),
  connect: z.lazy(() => source_connection_secretsWhereUniqueInputObjectSchema).optional()
}).strict();
