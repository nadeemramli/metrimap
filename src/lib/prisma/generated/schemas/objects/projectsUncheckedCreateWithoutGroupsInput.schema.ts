...
export const projectsUncheckedCreateWithoutGroupsInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutGroupsInput, Prisma.projectsUncheckedCreateWithoutGroupsInput> = z.object({
...
export const projectsUncheckedCreateWithoutGroupsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
