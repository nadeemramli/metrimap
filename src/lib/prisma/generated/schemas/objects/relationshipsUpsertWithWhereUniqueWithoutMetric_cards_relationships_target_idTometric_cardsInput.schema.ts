...
export const relationshipsUpsertWithWhereUniqueWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectSchema: z.ZodType<Prisma.relationshipsUpsertWithWhereUniqueWithoutMetric_cards_relationships_target_idTometric_cardsInput, Prisma.relationshipsUpsertWithWhereUniqueWithoutMetric_cards_relationships_target_idTometric_cardsInput> = z.object({
  where: z.lazy(() => relationshipsWhereUniqueInputObjectSchema),
  update: z.union([z.lazy(() => relationshipsUpdateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectSchema), z.lazy(() => relationshipsUncheckedUpdateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectSchema)]),
  create: z.union([z.lazy(() => relationshipsCreateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectSchema), z.lazy(() => relationshipsUncheckedCreateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectSchema)])
}).strict();
export const relationshipsUpsertWithWhereUniqueWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectZodSchema = z.object({
  where: z.lazy(() => relationshipsWhereUniqueInputObjectSchema),
  update: z.union([z.lazy(() => relationshipsUpdateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectSchema), z.lazy(() => relationshipsUncheckedUpdateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectSchema)]),
  create: z.union([z.lazy(() => relationshipsCreateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectSchema), z.lazy(() => relationshipsUncheckedCreateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectSchema)])
}).strict();
