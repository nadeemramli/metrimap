...
export const dashboard_widgetsUncheckedUpdateInputObjectSchema: z.ZodType<Prisma.dashboard_widgetsUncheckedUpdateInput, Prisma.dashboard_widgetsUncheckedUpdateInput> = z.object({
...
export const dashboard_widgetsUncheckedUpdateInputObjectZodSchema = z.object({
  project_id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  title: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  widget_type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  config: z.union([JsonNullValueInputSchema, jsonSchema]).optional(),
