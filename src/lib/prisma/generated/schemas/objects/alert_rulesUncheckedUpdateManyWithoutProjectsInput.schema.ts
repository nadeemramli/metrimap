...
export const alert_rulesUncheckedUpdateManyWithoutProjectsInputObjectSchema: z.ZodType<Prisma.alert_rulesUncheckedUpdateManyWithoutProjectsInput, Prisma.alert_rulesUncheckedUpdateManyWithoutProjectsInput> = z.object({
  card_id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
...
export const alert_rulesUncheckedUpdateManyWithoutProjectsInputObjectZodSchema = z.object({
  card_id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  rule_type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  config: z.union([JsonNullValueInputSchema, jsonSchema]).optional(),
