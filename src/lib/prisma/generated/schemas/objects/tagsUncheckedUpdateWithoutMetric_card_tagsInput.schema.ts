...
export const tagsUncheckedUpdateWithoutMetric_card_tagsInputObjectSchema: z.ZodType<Prisma.tagsUncheckedUpdateWithoutMetric_card_tagsInput, Prisma.tagsUncheckedUpdateWithoutMetric_card_tagsInput> = z.object({
...
export const tagsUncheckedUpdateWithoutMetric_card_tagsInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  color: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
