...
export const metric_cardsUncheckedCreateWithoutAlert_rulesInputObjectSchema: z.ZodType<Prisma.metric_cardsUncheckedCreateWithoutAlert_rulesInput, Prisma.metric_cardsUncheckedCreateWithoutAlert_rulesInput> = z.object({
...
export const metric_cardsUncheckedCreateWithoutAlert_rulesInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  title: z.string(),
  description: z.string().optional().nullable(),
