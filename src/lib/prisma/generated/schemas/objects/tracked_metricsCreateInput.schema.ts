...
export const tracked_metricsCreateInputObjectSchema: z.ZodType<Prisma.tracked_metricsCreateInput, Prisma.tracked_metricsCreateInput> = z.object({
...
export const tracked_metricsCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  name: z.string(),
  unit: z.string().optional().nullable(),
