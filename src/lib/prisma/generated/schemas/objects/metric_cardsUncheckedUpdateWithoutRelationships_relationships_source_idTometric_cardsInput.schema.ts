...
import { strategy_impact_contractsUncheckedUpdateOneWithoutMetric_cardsNestedInputObjectSchema } from './strategy_impact_contractsUncheckedUpdateOneWithoutMetric_cardsNestedInput.schema';
...
export const metric_cardsUncheckedUpdateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema: z.ZodType<Prisma.metric_cardsUncheckedUpdateWithoutRelationships_relationships_source_idTometric_cardsInput, Prisma.metric_cardsUncheckedUpdateWithoutRelationships_relationships_source_idTometric_cardsInput> = z.object({
  ...
  strategy_impact_contracts: z.lazy(() => strategy_impact_contractsUncheckedUpdateOneWithoutMetric_cardsNestedInputObjectSchema).optional(),
  strategy_metric_links: z.lazy(() => strategy_metric_linksUncheckedUpdateManyWithoutMetric_cardsNestedInputObjectSchema).optional()
}).strict();
export const metric_cardsUncheckedUpdateWithoutRelationships_relationships_source_idTometric_cardsInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  project_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  title: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
