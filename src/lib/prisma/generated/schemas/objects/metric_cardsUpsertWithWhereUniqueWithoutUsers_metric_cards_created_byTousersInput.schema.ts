...
export const metric_cardsUpsertWithWhereUniqueWithoutUsers_metric_cards_created_byTousersInputObjectSchema: z.ZodType<Prisma.metric_cardsUpsertWithWhereUniqueWithoutUsers_metric_cards_created_byTousersInput, Prisma.metric_cardsUpsertWithWhereUniqueWithoutUsers_metric_cards_created_byTousersInput> = z.object({
  where: z.lazy(() => metric_cardsWhereUniqueInputObjectSchema),
  update: z.union([z.lazy(() => metric_cardsUpdateWithoutUsers_metric_cards_created_byTousersInputObjectSchema), z.lazy(() => metric_cardsUncheckedUpdateWithoutUsers_metric_cards_created_byTousersInputObjectSchema)]),
...
export const metric_cardsUpsertWithWhereUniqueWithoutUsers_metric_cards_created_byTousersInputObjectZodSchema = z.object({
  where: z.lazy(() => metric_cardsWhereUniqueInputObjectSchema),
  update: z.union([z.lazy(() => metric_cardsUpdateWithoutUsers_metric_cards_created_byTousersInputObjectSchema), z.lazy(() => metric_cardsUncheckedUpdateWithoutUsers_metric_cards_created_byTousersInputObjectSchema)]),
  create: z.union([z.lazy(() => metric_cardsCreateWithoutUsers_metric_cards_created_byTousersInputObjectSchema), z.lazy(() => metric_cardsUncheckedCreateWithoutUsers_metric_cards_created_byTousersInputObjectSchema)])
}).strict();
