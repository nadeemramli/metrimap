...
export const groupsUncheckedUpdateManyWithoutUsersInputObjectSchema: z.ZodType<Prisma.groupsUncheckedUpdateManyWithoutUsersInput, Prisma.groupsUncheckedUpdateManyWithoutUsersInput> = z.object({
...
export const groupsUncheckedUpdateManyWithoutUsersInputObjectZodSchema = z.object({
  project_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  color: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
