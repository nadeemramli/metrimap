...
export const metric_cardsCreateWithoutAlert_rulesInputObjectSchema: z.ZodType<Prisma.metric_cardsCreateWithoutAlert_rulesInput, Prisma.metric_cardsCreateWithoutAlert_rulesInput> = z.object({
...
export const metric_cardsCreateWithoutAlert_rulesInputObjectZodSchema = z.object({
  id: z.string().optional(),
  title: z.string(),
  description: z.string().optional().nullable(),
  category: z.string(),
