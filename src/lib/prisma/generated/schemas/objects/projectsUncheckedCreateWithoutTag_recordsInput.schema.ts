...
export const projectsUncheckedCreateWithoutTag_recordsInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutTag_recordsInput, Prisma.projectsUncheckedCreateWithoutTag_recordsInput> = z.object({
...
export const projectsUncheckedCreateWithoutTag_recordsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
