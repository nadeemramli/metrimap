...
export const projectsUncheckedCreateWithoutUsers_projects_last_modified_byTousersInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutUsers_projects_last_modified_byTousersInput, Prisma.projectsUncheckedCreateWithoutUsers_projects_last_modified_byTousersInput> = z.object({
...
export const projectsUncheckedCreateWithoutUsers_projects_last_modified_byTousersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
