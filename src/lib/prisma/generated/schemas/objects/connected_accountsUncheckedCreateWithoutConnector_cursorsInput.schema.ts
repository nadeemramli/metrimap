...
export const connected_accountsUncheckedCreateWithoutConnector_cursorsInputObjectSchema: z.ZodType<Prisma.connected_accountsUncheckedCreateWithoutConnector_cursorsInput, Prisma.connected_accountsUncheckedCreateWithoutConnector_cursorsInput> = z.object({
...
export const connected_accountsUncheckedCreateWithoutConnector_cursorsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  connector_id: z.string(),
