...
export const usersUncheckedCreateWithoutGroupsInputObjectSchema: z.ZodType<Prisma.usersUncheckedCreateWithoutGroupsInput, Prisma.usersUncheckedCreateWithoutGroupsInput> = z.object({
...
export const usersUncheckedCreateWithoutGroupsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  name: z.string(),
  avatar_url: z.string().optional().nullable(),
