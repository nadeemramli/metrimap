...
export const error_reportsCreateManyInputObjectSchema: z.ZodType<Prisma.error_reportsCreateManyInput, Prisma.error_reportsCreateManyInput> = z.object({
...
export const error_reportsCreateManyInputObjectZodSchema = z.object({
  id: z.string().optional(),
  clerk_user_id: z.string().optional().nullable(),
  reporter_user_id: z.string().optional().nullable(),
  reporter_email: z.string().optional().nullable(),
