...
export const projectsUncheckedCreateWithoutCanvas_snapshotsInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutCanvas_snapshotsInput, Prisma.projectsUncheckedCreateWithoutCanvas_snapshotsInput> = z.object({
...
export const projectsUncheckedCreateWithoutCanvas_snapshotsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
