...
export const strategy_impact_contractsCreateWithoutStrategy_metric_linksInputObjectSchema: z.ZodType<Prisma.strategy_impact_contractsCreateWithoutStrategy_metric_linksInput, Prisma.strategy_impact_contractsCreateWithoutStrategy_metric_linksInput> = z.object({
...
export const strategy_impact_contractsCreateWithoutStrategy_metric_linksInputObjectZodSchema = z.object({
  id: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  expected_direction: z.string().optional().nullable(),
  expected_delta_value: z.number().optional().nullable(),
