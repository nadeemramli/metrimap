...
export const projectsUncheckedCreateWithoutCanvas_nodesInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutCanvas_nodesInput, Prisma.projectsUncheckedCreateWithoutCanvas_nodesInput> = z.object({
...
export const projectsUncheckedCreateWithoutCanvas_nodesInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
