...
export const metric_cardsUpsertWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema: z.ZodType<Prisma.metric_cardsUpsertWithoutRelationships_relationships_source_idTometric_cardsInput, Prisma.metric_cardsUpsertWithoutRelationships_relationships_source_idTometric_cardsInput> = z.object({
  update: z.union([z.lazy(() => metric_cardsUpdateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema), z.lazy(() => metric_cardsUncheckedUpdateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema)]),
  create: z.union([z.lazy(() => metric_cardsCreateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema), z.lazy(() => metric_cardsUncheckedCreateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema)]),
  where: z.lazy(() => metric_cardsWhereInputObjectSchema).optional()
}).strict();
export const metric_cardsUpsertWithoutRelationships_relationships_source_idTometric_cardsInputObjectZodSchema = z.object({
  update: z.union([z.lazy(() => metric_cardsUpdateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema), z.lazy(() => metric_cardsUncheckedUpdateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema)]),
  create: z.union([z.lazy(() => metric_cardsCreateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema), z.lazy(() => metric_cardsUncheckedCreateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema)]),
  where: z.lazy(() => metric_cardsWhereInputObjectSchema).optional()
}).strict();
