...
export const tracked_metricsUpdateManyMutationInputObjectSchema: z.ZodType<Prisma.tracked_metricsUpdateManyMutationInput, Prisma.tracked_metricsUpdateManyMutationInput> = z.object({
...
export const tracked_metricsUpdateManyMutationInputObjectZodSchema = z.object({
  created_by: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  unit: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  formula: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
