...
export const connector_runsCreateWithoutConnected_accountsInputObjectSchema: z.ZodType<Prisma.connector_runsCreateWithoutConnected_accountsInput, Prisma.connector_runsCreateWithoutConnected_accountsInput> = z.object({
...
export const connector_runsCreateWithoutConnected_accountsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  connector_id: z.string(),
