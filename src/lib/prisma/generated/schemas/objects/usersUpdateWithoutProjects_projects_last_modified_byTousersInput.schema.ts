...
export const usersUpdateWithoutProjects_projects_last_modified_byTousersInputObjectSchema: z.ZodType<Prisma.usersUpdateWithoutProjects_projects_last_modified_byTousersInput, Prisma.usersUpdateWithoutProjects_projects_last_modified_byTousersInput> = z.object({
...
export const usersUpdateWithoutProjects_projects_last_modified_byTousersInputObjectZodSchema = z.object({
  email: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  avatar_url: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  created_at: z.union([z.union([z.date(), z.string().datetime()]), z.lazy(() => NullableDateTimeFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
