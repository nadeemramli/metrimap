...
export const metric_cardsUncheckedCreateWithoutMetric_card_tagsInputObjectSchema: z.ZodType<Prisma.metric_cardsUncheckedCreateWithoutMetric_card_tagsInput, Prisma.metric_cardsUncheckedCreateWithoutMetric_card_tagsInput> = z.object({
...
export const metric_cardsUncheckedCreateWithoutMetric_card_tagsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  title: z.string(),
  description: z.string().optional().nullable(),
