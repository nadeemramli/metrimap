...
export const usersCreateWithoutTagsInputObjectSchema: z.ZodType<Prisma.usersCreateWithoutTagsInput, Prisma.usersCreateWithoutTagsInput> = z.object({
...
export const usersCreateWithoutTagsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  name: z.string(),
  avatar_url: z.string().optional().nullable(),
