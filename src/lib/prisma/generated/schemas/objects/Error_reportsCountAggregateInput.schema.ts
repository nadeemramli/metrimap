...
export const Error_reportsCountAggregateInputObjectSchema: z.ZodType<Prisma.Error_reportsCountAggregateInputType, Prisma.Error_reportsCountAggregateInputType> = z.object({
...
export const Error_reportsCountAggregateInputObjectZodSchema = z.object({
  id: z.literal(true).optional(),
  clerk_user_id: z.literal(true).optional(),
  reporter_user_id: z.literal(true).optional(),
  reporter_email: z.literal(true).optional(),
