...
export const tagsCreateWithoutUsersInputObjectSchema: z.ZodType<Prisma.tagsCreateWithoutUsersInput, Prisma.tagsCreateWithoutUsersInput> = z.object({
...
export const tagsCreateWithoutUsersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  color: z.string().optional().nullable(),
  description: z.string().optional().nullable(),
