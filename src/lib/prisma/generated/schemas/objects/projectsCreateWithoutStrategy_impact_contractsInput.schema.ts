...
export const projectsCreateWithoutStrategy_impact_contractsInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutStrategy_impact_contractsInput, Prisma.projectsCreateWithoutStrategy_impact_contractsInput> = z.object({
...
export const projectsCreateWithoutStrategy_impact_contractsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
