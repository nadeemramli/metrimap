...
export const relationshipsUncheckedUpdateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectSchema: z.ZodType<Prisma.relationshipsUncheckedUpdateWithoutMetric_cards_relationships_target_idTometric_cardsInput, Prisma.relationshipsUncheckedUpdateWithoutMetric_cards_relationships_target_idTometric_cardsInput> = z.object({
...
export const relationshipsUncheckedUpdateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  project_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  source_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
