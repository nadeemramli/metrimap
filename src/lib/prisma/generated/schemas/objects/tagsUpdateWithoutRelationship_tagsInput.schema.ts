...
export const tagsUpdateWithoutRelationship_tagsInputObjectSchema: z.ZodType<Prisma.tagsUpdateWithoutRelationship_tagsInput, Prisma.tagsUpdateWithoutRelationship_tagsInput> = z.object({
...
export const tagsUpdateWithoutRelationship_tagsInputObjectZodSchema = z.object({
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  color: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  created_at: z.union([z.union([z.date(), z.string().datetime()]), z.lazy(() => NullableDateTimeFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
