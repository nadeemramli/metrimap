...
export const strategy_impact_contractsCreateManyInputObjectSchema: z.ZodType<Prisma.strategy_impact_contractsCreateManyInput, Prisma.strategy_impact_contractsCreateManyInput> = z.object({
...
export const strategy_impact_contractsCreateManyInputObjectZodSchema = z.object({
  id: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  project_id: z.string().optional().nullable(),
  strategy_node_id: z.string(),
