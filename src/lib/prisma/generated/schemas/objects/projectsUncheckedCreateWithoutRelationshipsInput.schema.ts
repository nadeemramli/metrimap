...
export const projectsUncheckedCreateWithoutRelationshipsInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutRelationshipsInput, Prisma.projectsUncheckedCreateWithoutRelationshipsInput> = z.object({
...
export const projectsUncheckedCreateWithoutRelationshipsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
