...
export const project_collaboratorsUncheckedCreateWithoutUsersInputObjectSchema: z.ZodType<Prisma.project_collaboratorsUncheckedCreateWithoutUsersInput, Prisma.project_collaboratorsUncheckedCreateWithoutUsersInput> = z.object({
...
export const project_collaboratorsUncheckedCreateWithoutUsersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  role: z.string().optional(),
  permissions: z.union([z.lazy(() => project_collaboratorsCreatepermissionsInputObjectSchema), z.string().array()]).optional(),
