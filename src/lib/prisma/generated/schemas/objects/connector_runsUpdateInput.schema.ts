...
import { connected_accountsUpdateOneWithoutConnector_runsNestedInputObjectSchema } from './connected_accountsUpdateOneWithoutConnector_runsNestedInput.schema'

export const connector_runsUpdateInputObjectSchema: z.ZodType<Prisma.connector_runsUpdateInput, Prisma.connector_runsUpdateInput> = z.object({
  ...
  connected_accounts: z.lazy(() => connected_accountsUpdateOneWithoutConnector_runsNestedInputObjectSchema).optional()
}).strict();
export const connector_runsUpdateInputObjectZodSchema = z.object({
  created_by: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  workspace_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  connector_id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  stream: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
