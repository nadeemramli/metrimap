...
export const connected_accountsCreateWithoutConnected_account_secretsInputObjectSchema: z.ZodType<Prisma.connected_accountsCreateWithoutConnected_account_secretsInput, Prisma.connected_accountsCreateWithoutConnected_account_secretsInput> = z.object({
...
export const connected_accountsCreateWithoutConnected_account_secretsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  connector_id: z.string(),
