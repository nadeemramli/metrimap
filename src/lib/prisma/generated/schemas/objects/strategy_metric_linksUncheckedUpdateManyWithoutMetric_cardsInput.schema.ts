...
export const strategy_metric_linksUncheckedUpdateManyWithoutMetric_cardsInputObjectSchema: z.ZodType<Prisma.strategy_metric_linksUncheckedUpdateManyWithoutMetric_cardsInput, Prisma.strategy_metric_linksUncheckedUpdateManyWithoutMetric_cardsInput> = z.object({
...
export const strategy_metric_linksUncheckedUpdateManyWithoutMetric_cardsInputObjectZodSchema = z.object({
  contract_id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  workspace_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  role: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  ref_source: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
