...
export const tracked_metricsUncheckedCreateWithoutMetric_cardsInputObjectSchema: z.ZodType<Prisma.tracked_metricsUncheckedCreateWithoutMetric_cardsInput, Prisma.tracked_metricsUncheckedCreateWithoutMetric_cardsInput> = z.object({
...
export const tracked_metricsUncheckedCreateWithoutMetric_cardsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  name: z.string(),
  unit: z.string().optional().nullable(),
