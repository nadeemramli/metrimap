...
export const projectsUncheckedCreateWithoutRelationship_historyInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutRelationship_historyInput, Prisma.projectsUncheckedCreateWithoutRelationship_historyInput> = z.object({
...
export const projectsUncheckedCreateWithoutRelationship_historyInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
