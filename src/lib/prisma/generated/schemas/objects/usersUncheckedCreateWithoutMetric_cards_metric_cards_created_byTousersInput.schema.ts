...
export const usersUncheckedCreateWithoutMetric_cards_metric_cards_created_byTousersInputObjectSchema: z.ZodType<Prisma.usersUncheckedCreateWithoutMetric_cards_metric_cards_created_byTousersInput, Prisma.usersUncheckedCreateWithoutMetric_cards_metric_cards_created_byTousersInput> = z.object({
...
export const usersUncheckedCreateWithoutMetric_cards_metric_cards_created_byTousersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  name: z.string(),
  avatar_url: z.string().optional().nullable(),
