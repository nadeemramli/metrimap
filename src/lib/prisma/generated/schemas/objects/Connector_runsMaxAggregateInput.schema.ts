...
export const Connector_runsMaxAggregateInputObjectSchema: z.ZodType<Prisma.Connector_runsMaxAggregateInputType, Prisma.Connector_runsMaxAggregateInputType> = z.object({
...
export const Connector_runsMaxAggregateInputObjectZodSchema = z.object({
  id: z.literal(true).optional(),
  created_by: z.literal(true).optional(),
  workspace_id: z.literal(true).optional(),
  connected_account_id: z.literal(true).optional(),
