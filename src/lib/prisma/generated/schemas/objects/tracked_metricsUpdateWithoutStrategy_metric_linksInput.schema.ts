...
import { metric_bindingsUpdateManyWithoutTracked_metricsNestedInputObjectSchema } from './metric_bindingsUpdateManyWithoutTracked_metricsNestedInput.schema';
...
export const tracked_metricsUpdateWithoutStrategy_metric_linksInputObjectSchema: z.ZodType<Prisma.tracked_metricsUpdateWithoutStrategy_metric_linksInput, Prisma.tracked_metricsUpdateWithoutStrategy_metric_linksInput> = z.object({
  ...
  metric_bindings: z.lazy(() => metric_bindingsUpdateManyWithoutTracked_metricsNestedInputObjectSchema).optional(),
...
export const tracked_metricsUpdateWithoutStrategy_metric_linksInputObjectZodSchema = z.object({
  created_by: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  unit: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  formula: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
