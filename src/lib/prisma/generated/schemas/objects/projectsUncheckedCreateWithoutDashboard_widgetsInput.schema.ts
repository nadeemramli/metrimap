...
export const projectsUncheckedCreateWithoutDashboard_widgetsInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutDashboard_widgetsInput, Prisma.projectsUncheckedCreateWithoutDashboard_widgetsInput> = z.object({
...
export const projectsUncheckedCreateWithoutDashboard_widgetsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
