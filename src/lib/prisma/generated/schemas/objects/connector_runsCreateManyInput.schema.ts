...
export const connector_runsCreateManyInputObjectSchema: z.ZodType<Prisma.connector_runsCreateManyInput, Prisma.connector_runsCreateManyInput> = z.object({
...
export const connector_runsCreateManyInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  connected_account_id: z.string().optional().nullable(),
