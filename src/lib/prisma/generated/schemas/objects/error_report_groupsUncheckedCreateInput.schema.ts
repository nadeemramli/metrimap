...
export const error_report_groupsUncheckedCreateInputObjectSchema: z.ZodType<Prisma.error_report_groupsUncheckedCreateInput, Prisma.error_report_groupsUncheckedCreateInput> = z.object({
...
export const error_report_groupsUncheckedCreateInputObjectZodSchema = z.object({
  fingerprint: z.string(),
  title: z.string().optional().nullable(),
  first_seen_at: z.union([z.date(), z.string().datetime()]).optional(),
  last_seen_at: z.union([z.date(), z.string().datetime()]).optional(),
