...
export const relationshipsUncheckedCreateWithoutUsersInputObjectSchema: z.ZodType<Prisma.relationshipsUncheckedCreateWithoutUsersInput, Prisma.relationshipsUncheckedCreateWithoutUsersInput> = z.object({
...
export const relationshipsUncheckedCreateWithoutUsersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  source_id: z.string().optional().nullable(),
  target_id: z.string().optional().nullable(),
