...
export const connected_accountsUncheckedCreateWithoutMetric_bindingsInputObjectSchema: z.ZodType<Prisma.connected_accountsUncheckedCreateWithoutMetric_bindingsInput, Prisma.connected_accountsUncheckedCreateWithoutMetric_bindingsInput> = z.object({
...
export const connected_accountsUncheckedCreateWithoutMetric_bindingsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  connector_id: z.string(),
