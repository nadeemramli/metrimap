...
export const workspace_groupsCreateInputObjectSchema: z.ZodType<Prisma.workspace_groupsCreateInput, Prisma.workspace_groupsCreateInput> = z.object({
...
export const workspace_groupsCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  workspace_id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
