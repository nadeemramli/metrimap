...
export const metric_cardsUncheckedCreateWithoutUsers_metric_cards_owner_idTousersInputObjectSchema: z.ZodType<Prisma.metric_cardsUncheckedCreateWithoutUsers_metric_cards_owner_idTousersInput, Prisma.metric_cardsUncheckedCreateWithoutUsers_metric_cards_owner_idTousersInput> = z.object({
...
export const metric_cardsUncheckedCreateWithoutUsers_metric_cards_owner_idTousersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  title: z.string(),
  description: z.string().optional().nullable(),
