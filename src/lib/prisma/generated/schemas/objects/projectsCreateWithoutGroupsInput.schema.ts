...
export const projectsCreateWithoutGroupsInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutGroupsInput, Prisma.projectsCreateWithoutGroupsInput> = z.object({
...
export const projectsCreateWithoutGroupsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
