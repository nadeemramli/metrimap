...
export const usersUncheckedUpdateWithoutMetric_cards_metric_cards_owner_idTousersInputObjectSchema: z.ZodType<Prisma.usersUncheckedUpdateWithoutMetric_cards_metric_cards_owner_idTousersInput, Prisma.usersUncheckedUpdateWithoutMetric_cards_metric_cards_owner_idTousersInput> = z.object({
...
export const usersUncheckedUpdateWithoutMetric_cards_metric_cards_owner_idTousersInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  email: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  avatar_url: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
