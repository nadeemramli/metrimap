...
export const usersUncheckedCreateWithoutTagsInputObjectSchema: z.ZodType<Prisma.usersUncheckedCreateWithoutTagsInput, Prisma.usersUncheckedCreateWithoutTagsInput> = z.object({
...
export const usersUncheckedCreateWithoutTagsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  name: z.string(),
  avatar_url: z.string().optional().nullable(),
