...
export const Connected_accountsCountAggregateInputObjectSchema: z.ZodType<Prisma.Connected_accountsCountAggregateInputType, Prisma.Connected_accountsCountAggregateInputType> = z.object({
  ...
  granted_scopes: z.literal(true).optional(),
...
export const Connected_accountsCountAggregateInputObjectZodSchema = z.object({
  id: z.literal(true).optional(),
  created_by: z.literal(true).optional(),
  workspace_id: z.literal(true).optional(),
  connector_id: z.literal(true).optional(),
