...
import { relationship_historyCreateNestedManyWithoutProjectsInputObjectSchema } from './relationship_historyCreateNestedManyWithoutProjectsInput.schema';
...
export const projectsCreateWithoutUsers_projects_last_modified_byTousersInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutUsers_projects_last_modified_byTousersInput, Prisma.projectsCreateWithoutUsers_projects_last_modified_byTousersInput> = z.object({
  ...
  relationship_history: z.lazy(() => relationship_historyCreateNestedManyWithoutProjectsInputObjectSchema).optional(),
...
export const projectsCreateWithoutUsers_projects_last_modified_byTousersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
