...
export const projectsCreateWithoutChangelogInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutChangelogInput, Prisma.projectsCreateWithoutChangelogInput> = z.object({
...
export const projectsCreateWithoutChangelogInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
