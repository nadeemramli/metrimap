...
import { projectsUpdateOneRequiredWithoutDashboard_widgetsNestedInputObjectSchema } from './projectsUpdateOneRequiredWithoutDashboard_widgetsNestedInput.schema'
...
export const dashboard_widgetsUpdateInputObjectSchema: z.ZodType<Prisma.dashboard_widgetsUpdateInput, Prisma.dashboard_widgetsUpdateInput> = z.object({
  ...
  projects: z.lazy(() => projectsUpdateOneRequiredWithoutDashboard_widgetsNestedInputObjectSchema).optional()
}).strict();
export const dashboard_widgetsUpdateInputObjectZodSchema = z.object({
  title: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  widget_type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  config: z.union([JsonNullValueInputSchema, jsonSchema]).optional(),
  layout: z.union([JsonNullValueInputSchema, jsonSchema]).optional(),
