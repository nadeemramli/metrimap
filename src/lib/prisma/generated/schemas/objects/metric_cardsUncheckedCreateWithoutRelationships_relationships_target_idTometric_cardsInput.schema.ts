...
import { node_access_grantsUncheckedCreateNestedManyWithoutMetric_cardsInputObjectSchema } from './node_access_grantsUncheckedCreateNestedManyWithoutMetric_cardsInput.schema';
...
export const metric_cardsUncheckedCreateWithoutRelationships_relationships_target_idTometric_cardsInputObjectSchema: z.ZodType<Prisma.metric_cardsUncheckedCreateWithoutRelationships_relationships_target_idTometric_cardsInput, Prisma.metric_cardsUncheckedCreateWithoutRelationships_relationships_target_idTometric_cardsInput> = z.object({
  ...
  node_access_grants: z.lazy(() => node_access_grantsUncheckedCreateNestedManyWithoutMetric_cardsInputObjectSchema).optional(),
...
export const metric_cardsUncheckedCreateWithoutRelationships_relationships_target_idTometric_cardsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  title: z.string(),
  description: z.string().optional().nullable(),
