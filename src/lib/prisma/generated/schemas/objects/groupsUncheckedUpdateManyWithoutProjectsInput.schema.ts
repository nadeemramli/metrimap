...
export const groupsUncheckedUpdateManyWithoutProjectsInputObjectSchema: z.ZodType<Prisma.groupsUncheckedUpdateManyWithoutProjectsInput, Prisma.groupsUncheckedUpdateManyWithoutProjectsInput> = z.object({
...
export const groupsUncheckedUpdateManyWithoutProjectsInputObjectZodSchema = z.object({
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  color: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  position_x: z.union([z.number(), z.lazy(() => FloatFieldUpdateOperationsInputObjectSchema)]).optional(),
