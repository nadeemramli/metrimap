...
export const canvas_snapshotsUncheckedUpdateManyWithoutProjectsInputObjectSchema: z.ZodType<Prisma.canvas_snapshotsUncheckedUpdateManyWithoutProjectsInput, Prisma.canvas_snapshotsUncheckedUpdateManyWithoutProjectsInput> = z.object({
...
export const canvas_snapshotsUncheckedUpdateManyWithoutProjectsInputObjectZodSchema = z.object({
  version: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  title: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  nodes: z.union([JsonNullValueInputSchema, jsonSchema]).optional(),
