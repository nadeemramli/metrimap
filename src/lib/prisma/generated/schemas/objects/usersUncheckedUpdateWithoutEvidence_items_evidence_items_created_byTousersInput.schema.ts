...
export const usersUncheckedUpdateWithoutEvidence_items_evidence_items_created_byTousersInputObjectSchema: z.ZodType<Prisma.usersUncheckedUpdateWithoutEvidence_items_evidence_items_created_byTousersInput, Prisma.usersUncheckedUpdateWithoutEvidence_items_evidence_items_created_byTousersInput> = z.object({
...
export const usersUncheckedUpdateWithoutEvidence_items_evidence_items_created_byTousersInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  email: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  avatar_url: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
