...
export const canvas_snapshotsUncheckedUpdateInputObjectSchema: z.ZodType<Prisma.canvas_snapshotsUncheckedUpdateInput, Prisma.canvas_snapshotsUncheckedUpdateInput> = z.object({
...
export const canvas_snapshotsUncheckedUpdateInputObjectZodSchema = z.object({
  canvas_id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  version: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  title: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
