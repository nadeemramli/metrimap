...
export const alert_rulesUpdateWithoutMetric_cardsInputObjectSchema: z.ZodType<Prisma.alert_rulesUpdateWithoutMetric_cardsInput, Prisma.alert_rulesUpdateWithoutMetric_cardsInput> = z.object({
...
export const alert_rulesUpdateWithoutMetric_cardsInputObjectZodSchema = z.object({
  name: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  rule_type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  config: z.union([JsonNullValueInputSchema, jsonSchema]).optional(),
  enabled: z.union([z.boolean(), z.lazy(() => BoolFieldUpdateOperationsInputObjectSchema)]).optional(),
