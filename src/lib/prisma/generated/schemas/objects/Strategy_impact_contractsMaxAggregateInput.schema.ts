...
export const Strategy_impact_contractsMaxAggregateInputObjectSchema: z.ZodType<Prisma.Strategy_impact_contractsMaxAggregateInputType, Prisma.Strategy_impact_contractsMaxAggregateInputType> = z.object({
...
export const Strategy_impact_contractsMaxAggregateInputObjectZodSchema = z.object({
  id: z.literal(true).optional(),
  workspace_id: z.literal(true).optional(),
  project_id: z.literal(true).optional(),
  strategy_node_id: z.literal(true).optional(),
