...
export const evidence_itemsUncheckedUpdateManyWithoutProjectsInputObjectSchema: z.ZodType<Prisma.evidence_itemsUncheckedUpdateManyWithoutProjectsInput, Prisma.evidence_itemsUncheckedUpdateManyWithoutProjectsInput> = z.object({
...
export const evidence_itemsUncheckedUpdateManyWithoutProjectsInputObjectZodSchema = z.object({
  relationship_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  title: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  date: z.union([z.union([z.date(), z.string().datetime()]), z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(),
