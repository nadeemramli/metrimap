...
export const metric_cardsUncheckedCreateWithoutTracked_metricsInputObjectSchema: z.ZodType<Prisma.metric_cardsUncheckedCreateWithoutTracked_metricsInput, Prisma.metric_cardsUncheckedCreateWithoutTracked_metricsInput> = z.object({
...
export const metric_cardsUncheckedCreateWithoutTracked_metricsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  title: z.string(),
  description: z.string().optional().nullable(),
