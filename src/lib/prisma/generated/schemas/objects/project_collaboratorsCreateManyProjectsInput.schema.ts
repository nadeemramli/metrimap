...
export const project_collaboratorsCreateManyProjectsInputObjectSchema: z.ZodType<Prisma.project_collaboratorsCreateManyProjectsInput, Prisma.project_collaboratorsCreateManyProjectsInput> = z.object({
...
export const project_collaboratorsCreateManyProjectsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  user_id: z.string().optional().nullable(),
  role: z.string().optional(),
  permissions: z.union([z.lazy(() => project_collaboratorsCreatepermissionsInputObjectSchema), z.string().array()]).optional(),
