...
export const metric_cardsUncheckedCreateWithoutStrategy_metric_linksInputObjectSchema: z.ZodType<Prisma.metric_cardsUncheckedCreateWithoutStrategy_metric_linksInput, Prisma.metric_cardsUncheckedCreateWithoutStrategy_metric_linksInput> = z.object({
...
export const metric_cardsUncheckedCreateWithoutStrategy_metric_linksInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  title: z.string(),
  description: z.string().optional().nullable(),
