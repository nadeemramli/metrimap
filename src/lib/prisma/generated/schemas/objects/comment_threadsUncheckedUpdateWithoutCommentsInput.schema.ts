...
export const comment_threadsUncheckedUpdateWithoutCommentsInputObjectSchema: z.ZodType<Prisma.comment_threadsUncheckedUpdateWithoutCommentsInput, Prisma.comment_threadsUncheckedUpdateWithoutCommentsInput> = z.object({
...
export const comment_threadsUncheckedUpdateWithoutCommentsInputObjectZodSchema = z.object({
  id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  project_id: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  source: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  context: z.union([NullableJsonNullValueInputSchema, jsonSchema]).optional(),
