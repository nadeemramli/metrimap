...
import { source_connection_secretsUpdateOneWithoutSource_connectionsNestedInputObjectSchema } from './source_connection_secretsUpdateOneWithoutSource_connectionsNestedInput.schema'

export const source_connectionsUpdateInputObjectSchema: z.ZodType<Prisma.source_connectionsUpdateInput, Prisma.source_connectionsUpdateInput> = z.object({
  ...
  source_connection_secrets: z.lazy(() => source_connection_secretsUpdateOneWithoutSource_connectionsNestedInputObjectSchema).optional()
}).strict();
export const source_connectionsUpdateInputObjectZodSchema = z.object({
  created_by: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  warehouse_type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  host: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
