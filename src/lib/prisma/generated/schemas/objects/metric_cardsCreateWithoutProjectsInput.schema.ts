...
export const metric_cardsCreateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.metric_cardsCreateWithoutProjectsInput, Prisma.metric_cardsCreateWithoutProjectsInput> = z.object({
...
export const metric_cardsCreateWithoutProjectsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  title: z.string(),
  description: z.string().optional().nullable(),
  category: z.string(),
