...
export const relationshipsUncheckedUpdateManyWithoutMetric_cards_relationships_source_idTometric_cardsInputObjectSchema: z.ZodType<Prisma.relationshipsUncheckedUpdateManyWithoutMetric_cards_relationships_source_idTometric_cardsInput, Prisma.relationshipsUncheckedUpdateManyWithoutMetric_cards_relationships_source_idTometric_cardsInput> = z.object({
...
export const relationshipsUncheckedUpdateManyWithoutMetric_cards_relationships_source_idTometric_cardsInputObjectZodSchema = z.object({
  project_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  target_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  type: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  confidence: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
