...
export const Error_report_groupsMaxAggregateInputObjectSchema: z.ZodType<Prisma.Error_report_groupsMaxAggregateInputType, Prisma.Error_report_groupsMaxAggregateInputType> = z.object({
...
export const Error_report_groupsMaxAggregateInputObjectZodSchema = z.object({
  fingerprint: z.literal(true).optional(),
  title: z.literal(true).optional(),
  first_seen_at: z.literal(true).optional(),
  last_seen_at: z.literal(true).optional(),
