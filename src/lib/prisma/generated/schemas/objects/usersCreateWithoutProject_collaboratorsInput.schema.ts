...
export const usersCreateWithoutProject_collaboratorsInputObjectSchema: z.ZodType<Prisma.usersCreateWithoutProject_collaboratorsInput, Prisma.usersCreateWithoutProject_collaboratorsInput> = z.object({
...
export const usersCreateWithoutProject_collaboratorsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  name: z.string(),
  avatar_url: z.string().optional().nullable(),
