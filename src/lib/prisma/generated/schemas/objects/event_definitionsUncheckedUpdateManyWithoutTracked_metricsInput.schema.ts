...
export const event_definitionsUncheckedUpdateManyWithoutTracked_metricsInputObjectSchema: z.ZodType<Prisma.event_definitionsUncheckedUpdateManyWithoutTracked_metricsInput, Prisma.event_definitionsUncheckedUpdateManyWithoutTracked_metricsInput> = z.object({
...
export const event_definitionsUncheckedUpdateManyWithoutTracked_metricsInputObjectZodSchema = z.object({
  created_by: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  key: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  category: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
