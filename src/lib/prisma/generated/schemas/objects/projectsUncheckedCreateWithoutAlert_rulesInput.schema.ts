...
export const projectsUncheckedCreateWithoutAlert_rulesInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutAlert_rulesInput, Prisma.projectsUncheckedCreateWithoutAlert_rulesInput> = z.object({
...
export const projectsUncheckedCreateWithoutAlert_rulesInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
