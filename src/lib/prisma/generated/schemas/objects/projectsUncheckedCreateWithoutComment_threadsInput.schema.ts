...
export const projectsUncheckedCreateWithoutComment_threadsInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutComment_threadsInput, Prisma.projectsUncheckedCreateWithoutComment_threadsInput> = z.object({
...
export const projectsUncheckedCreateWithoutComment_threadsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
