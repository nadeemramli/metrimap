...
export const usersCreateWithoutChangelogInputObjectSchema: z.ZodType<Prisma.usersCreateWithoutChangelogInput, Prisma.usersCreateWithoutChangelogInput> = z.object({
...
export const usersCreateWithoutChangelogInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  name: z.string(),
  avatar_url: z.string().optional().nullable(),
