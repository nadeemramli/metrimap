...
export const metric_cardsCreateManyTracked_metricsInputObjectSchema: z.ZodType<Prisma.metric_cardsCreateManyTracked_metricsInput, Prisma.metric_cardsCreateManyTracked_metricsInput> = z.object({
...
export const metric_cardsCreateManyTracked_metricsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  title: z.string(),
  description: z.string().optional().nullable(),
