...
export const connected_accountsCreateWithoutConnector_runsInputObjectSchema: z.ZodType<Prisma.connected_accountsCreateWithoutConnector_runsInput, Prisma.connected_accountsCreateWithoutConnector_runsInput> = z.object({
...
export const connected_accountsCreateWithoutConnector_runsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  connector_id: z.string(),
