...
import { strategy_metric_linksCreateNestedManyWithoutMetric_cardsInputObjectSchema } from './strategy_metric_linksCreateNestedManyWithoutMetric_cardsInput.schema'
...
export const metric_cardsCreateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema: z.ZodType<Prisma.metric_cardsCreateWithoutRelationships_relationships_source_idTometric_cardsInput, Prisma.metric_cardsCreateWithoutRelationships_relationships_source_idTometric_cardsInput> = z.object({
  ...
  strategy_metric_links: z.lazy(() => strategy_metric_linksCreateNestedManyWithoutMetric_cardsInputObjectSchema).optional()
}).strict();
export const metric_cardsCreateWithoutRelationships_relationships_source_idTometric_cardsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  title: z.string(),
  description: z.string().optional().nullable(),
  category: z.string(),
