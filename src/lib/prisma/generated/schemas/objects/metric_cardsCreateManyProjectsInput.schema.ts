...
export const metric_cardsCreateManyProjectsInputObjectSchema: z.ZodType<Prisma.metric_cardsCreateManyProjectsInput, Prisma.metric_cardsCreateManyProjectsInput> = z.object({
...
export const metric_cardsCreateManyProjectsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  title: z.string(),
  description: z.string().optional().nullable(),
  category: z.string(),
