...
export const tracked_metricsCreateWithoutStrategy_metric_linksInputObjectSchema: z.ZodType<Prisma.tracked_metricsCreateWithoutStrategy_metric_linksInput, Prisma.tracked_metricsCreateWithoutStrategy_metric_linksInput> = z.object({
...
export const tracked_metricsCreateWithoutStrategy_metric_linksInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  name: z.string(),
  unit: z.string().optional().nullable(),
