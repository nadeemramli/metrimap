...
export const projectsCreateWithoutMetric_cardsInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutMetric_cardsInput, Prisma.projectsCreateWithoutMetric_cardsInput> = z.object({
...
export const projectsCreateWithoutMetric_cardsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
