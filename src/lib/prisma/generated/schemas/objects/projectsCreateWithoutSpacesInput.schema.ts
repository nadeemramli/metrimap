...
export const projectsCreateWithoutSpacesInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutSpacesInput, Prisma.projectsCreateWithoutSpacesInput> = z.object({
...
export const projectsCreateWithoutSpacesInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
