...
export const metric_cardsCreateWithoutTracked_metricsInputObjectSchema: z.ZodType<Prisma.metric_cardsCreateWithoutTracked_metricsInput, Prisma.metric_cardsCreateWithoutTracked_metricsInput> = z.object({
...
export const metric_cardsCreateWithoutTracked_metricsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  title: z.string(),
  description: z.string().optional().nullable(),
  category: z.string(),
