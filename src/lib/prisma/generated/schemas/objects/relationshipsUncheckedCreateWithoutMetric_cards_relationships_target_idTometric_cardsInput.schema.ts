...
export const relationshipsUncheckedCreateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectSchema: z.ZodType<Prisma.relationshipsUncheckedCreateWithoutMetric_cards_relationships_target_idTometric_cardsInput, Prisma.relationshipsUncheckedCreateWithoutMetric_cards_relationships_target_idTometric_cardsInput> = z.object({
...
export const relationshipsUncheckedCreateWithoutMetric_cards_relationships_target_idTometric_cardsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  source_id: z.string().optional().nullable(),
  type: z.string(),
