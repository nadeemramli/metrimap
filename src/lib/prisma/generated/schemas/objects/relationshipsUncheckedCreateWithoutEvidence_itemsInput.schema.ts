...
export const relationshipsUncheckedCreateWithoutEvidence_itemsInputObjectSchema: z.ZodType<Prisma.relationshipsUncheckedCreateWithoutEvidence_itemsInput, Prisma.relationshipsUncheckedCreateWithoutEvidence_itemsInput> = z.object({
...
export const relationshipsUncheckedCreateWithoutEvidence_itemsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  source_id: z.string().optional().nullable(),
  target_id: z.string().optional().nullable(),
