...
export const projectsCreateWithoutCanvas_nodesInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutCanvas_nodesInput, Prisma.projectsCreateWithoutCanvas_nodesInput> = z.object({
...
export const projectsCreateWithoutCanvas_nodesInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
