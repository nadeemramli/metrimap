...
export const projectsCreateManySpacesInputObjectSchema: z.ZodType<Prisma.projectsCreateManySpacesInput, Prisma.projectsCreateManySpacesInput> = z.object({
...
export const projectsCreateManySpacesInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
