...
export const relationshipsUncheckedCreateWithoutRelationship_tagsInputObjectSchema: z.ZodType<Prisma.relationshipsUncheckedCreateWithoutRelationship_tagsInput, Prisma.relationshipsUncheckedCreateWithoutRelationship_tagsInput> = z.object({
...
export const relationshipsUncheckedCreateWithoutRelationship_tagsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  source_id: z.string().optional().nullable(),
  target_id: z.string().optional().nullable(),
