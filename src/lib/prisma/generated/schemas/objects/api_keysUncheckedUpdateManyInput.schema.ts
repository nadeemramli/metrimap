...
export const api_keysUncheckedUpdateManyInputObjectSchema: z.ZodType<Prisma.api_keysUncheckedUpdateManyInput, Prisma.api_keysUncheckedUpdateManyInput> = z.object({
...
export const api_keysUncheckedUpdateManyInputObjectZodSchema = z.object({
  workspace_id: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  created_by: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  key_prefix: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
