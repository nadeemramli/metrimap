...
export const projectsCreateWithoutRelationshipsInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutRelationshipsInput, Prisma.projectsCreateWithoutRelationshipsInput> = z.object({
...
export const projectsCreateWithoutRelationshipsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
