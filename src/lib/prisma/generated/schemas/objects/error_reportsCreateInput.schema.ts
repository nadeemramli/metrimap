...
export const error_reportsCreateInputObjectSchema: z.ZodType<Prisma.error_reportsCreateInput, Prisma.error_reportsCreateInput> = z.object({
...
export const error_reportsCreateInputObjectZodSchema = z.object({
  id: z.string().optional(),
  clerk_user_id: z.string().optional().nullable(),
  reporter_user_id: z.string().optional().nullable(),
  reporter_email: z.string().optional().nullable(),
