...
export const projectsCreateWithoutTag_recordsInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutTag_recordsInput, Prisma.projectsCreateWithoutTag_recordsInput> = z.object({
...
export const projectsCreateWithoutTag_recordsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
