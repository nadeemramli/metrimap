...
export const metric_cardsUncheckedCreateWithoutStrategy_impact_contractsInputObjectSchema: z.ZodType<Prisma.metric_cardsUncheckedCreateWithoutStrategy_impact_contractsInput, Prisma.metric_cardsUncheckedCreateWithoutStrategy_impact_contractsInput> = z.object({
...
export const metric_cardsUncheckedCreateWithoutStrategy_impact_contractsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  title: z.string(),
  description: z.string().optional().nullable(),
