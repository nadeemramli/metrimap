...
export const Strategy_impact_contractsMinAggregateInputObjectSchema: z.ZodType<Prisma.Strategy_impact_contractsMinAggregateInputType, Prisma.Strategy_impact_contractsMinAggregateInputType> = z.object({
...
export const Strategy_impact_contractsMinAggregateInputObjectZodSchema = z.object({
  id: z.literal(true).optional(),
  workspace_id: z.literal(true).optional(),
  project_id: z.literal(true).optional(),
  strategy_node_id: z.literal(true).optional(),
