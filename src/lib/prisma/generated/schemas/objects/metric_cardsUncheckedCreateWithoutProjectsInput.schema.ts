...
export const metric_cardsUncheckedCreateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.metric_cardsUncheckedCreateWithoutProjectsInput, Prisma.metric_cardsUncheckedCreateWithoutProjectsInput> = z.object({
...
export const metric_cardsUncheckedCreateWithoutProjectsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  title: z.string(),
  description: z.string().optional().nullable(),
  category: z.string(),
