...
import { Connected_accountsNullableScalarRelationFilterObjectSchema } from './Connected_accountsNullableScalarRelationFilter.schema';
import { connected_accountsWhereInputObjectSchema } from './connected_accountsWhereInput.schema'

export const connector_runsWhereInputObjectSchema: z.ZodType<Prisma.connector_runsWhereInput, Prisma.connector_runsWhereInput> = z.object({
  AND: z.union([z.lazy(() => connector_runsWhereInputObjectSchema), z.lazy(() => connector_runsWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => connector_runsWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => connector_runsWhereInputObjectSchema), z.lazy(() => connector_runsWhereInputObjectSchema).array()]).optional(),
  ...
  connected_accounts: z.union([z.lazy(() => Connected_accountsNullableScalarRelationFilterObjectSchema), z.lazy(() => connected_accountsWhereInputObjectSchema)]).optional().nullable()
}).strict();
export const connector_runsWhereInputObjectZodSchema = z.object({
  AND: z.union([z.lazy(() => connector_runsWhereInputObjectSchema), z.lazy(() => connector_runsWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => connector_runsWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => connector_runsWhereInputObjectSchema), z.lazy(() => connector_runsWhereInputObjectSchema).array()]).optional(),
  created_by: z.union([z.lazy(() => StringFilterObjectSchema), z.string()]).optional(),
