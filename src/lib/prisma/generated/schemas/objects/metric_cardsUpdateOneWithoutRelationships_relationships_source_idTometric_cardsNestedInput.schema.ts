...
import { metric_cardsUpsertWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema } from './metric_cardsUpsertWithoutRelationships_relationships_source_idTometric_cardsInput.schema';
...
import { metric_cardsUpdateToOneWithWhereWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema } from './metric_cardsUpdateToOneWithWhereWithoutRelationships_relationships_source_idTometric_cardsInput.schema';
...
export const metric_cardsUpdateOneWithoutRelationships_relationships_source_idTometric_cardsNestedInputObjectSchema: z.ZodType<Prisma.metric_cardsUpdateOneWithoutRelationships_relationships_source_idTometric_cardsNestedInput, Prisma.metric_cardsUpdateOneWithoutRelationships_relationships_source_idTometric_cardsNestedInput> = z.object({
  ...
  upsert: z.lazy(() => metric_cardsUpsertWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema).optional(),
  ...
  update: z.union([z.lazy(() => metric_cardsUpdateToOneWithWhereWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema), z.lazy(() => metric_cardsUpdateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema), z.lazy(() => metric_cardsUncheckedUpdateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema)]).optional()
}).strict();
export const metric_cardsUpdateOneWithoutRelationships_relationships_source_idTometric_cardsNestedInputObjectZodSchema = z.object({
  create: z.union([z.lazy(() => metric_cardsCreateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema), z.lazy(() => metric_cardsUncheckedCreateWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema)]).optional(),
  connectOrCreate: z.lazy(() => metric_cardsCreateOrConnectWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema).optional(),
  upsert: z.lazy(() => metric_cardsUpsertWithoutRelationships_relationships_source_idTometric_cardsInputObjectSchema).optional(),
  disconnect: z.union([z.boolean(), z.lazy(() => metric_cardsWhereInputObjectSchema)]).optional(),
