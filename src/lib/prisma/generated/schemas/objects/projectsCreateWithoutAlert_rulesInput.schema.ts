...
export const projectsCreateWithoutAlert_rulesInputObjectSchema: z.ZodType<Prisma.projectsCreateWithoutAlert_rulesInput, Prisma.projectsCreateWithoutAlert_rulesInput> = z.object({
...
export const projectsCreateWithoutAlert_rulesInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
