...
export const projectsUncheckedUpdateManyWithoutUsers_projects_created_byTousersInputObjectSchema: z.ZodType<Prisma.projectsUncheckedUpdateManyWithoutUsers_projects_created_byTousersInput, Prisma.projectsUncheckedUpdateManyWithoutUsers_projects_created_byTousersInput> = z.object({
...
export const projectsUncheckedUpdateManyWithoutUsers_projects_created_byTousersInputObjectZodSchema = z.object({
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  tags: z.union([z.lazy(() => projectsUpdatetagsInputObjectSchema), z.string().array()]).optional(),
  settings: z.union([NullableJsonNullValueInputSchema, jsonSchema]).optional(),
