...
import { project_collaboratorsUncheckedCreateNestedManyWithoutUsersInputObjectSchema } from './project_collaboratorsUncheckedCreateNestedManyWithoutUsersInput.schema';
...
export const usersUncheckedCreateWithoutEvidence_items_evidence_items_created_byTousersInputObjectSchema: z.ZodType<Prisma.usersUncheckedCreateWithoutEvidence_items_evidence_items_created_byTousersInput, Prisma.usersUncheckedCreateWithoutEvidence_items_evidence_items_created_byTousersInput> = z.object({
  ...
  project_collaborators: z.lazy(() => project_collaboratorsUncheckedCreateNestedManyWithoutUsersInputObjectSchema).optional(),
...
export const usersUncheckedCreateWithoutEvidence_items_evidence_items_created_byTousersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  name: z.string(),
  avatar_url: z.string().optional().nullable(),
