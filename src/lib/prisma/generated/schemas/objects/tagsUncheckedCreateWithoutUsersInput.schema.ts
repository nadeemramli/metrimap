...
export const tagsUncheckedCreateWithoutUsersInputObjectSchema: z.ZodType<Prisma.tagsUncheckedCreateWithoutUsersInput, Prisma.tagsUncheckedCreateWithoutUsersInput> = z.object({
...
export const tagsUncheckedCreateWithoutUsersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  color: z.string().optional().nullable(),
  description: z.string().optional().nullable(),
