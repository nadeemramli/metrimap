...
export const comment_threadsCreateManyInputObjectSchema: z.ZodType<Prisma.comment_threadsCreateManyInput, Prisma.comment_threadsCreateManyInput> = z.object({
  project_id: z.string(),
  source: z.string(),
