...
export const connected_account_secretsUncheckedCreateNestedOneWithoutConnected_accountsInputObjectSchema: z.ZodType<Prisma.connected_account_secretsUncheckedCreateNestedOneWithoutConnected_accountsInput, Prisma.connected_account_secretsUncheckedCreateNestedOneWithoutConnected_accountsInput> = z.object({
...
export const connected_account_secretsUncheckedCreateNestedOneWithoutConnected_accountsInputObjectZodSchema = z.object({
  create: z.union([z.lazy(() => connected_account_secretsCreateWithoutConnected_accountsInputObjectSchema), z.lazy(() => connected_account_secretsUncheckedCreateWithoutConnected_accountsInputObjectSchema)]).optional(),
  connectOrCreate: z.lazy(() => connected_account_secretsCreateOrConnectWithoutConnected_accountsInputObjectSchema).optional(),
  connect: z.lazy(() => connected_account_secretsWhereUniqueInputObjectSchema).optional()
}).strict();
