...
export const changelogCreateWithoutUsersInputObjectSchema: z.ZodType<Prisma.changelogCreateWithoutUsersInput, Prisma.changelogCreateWithoutUsersInput> = z.object({
...
export const changelogCreateWithoutUsersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  action: z.string(),
  target: z.string(),
  target_id: z.string().optional().nullable(),
