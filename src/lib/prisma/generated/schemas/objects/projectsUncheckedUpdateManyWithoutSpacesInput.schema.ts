...
export const projectsUncheckedUpdateManyWithoutSpacesInputObjectSchema: z.ZodType<Prisma.projectsUncheckedUpdateManyWithoutSpacesInput, Prisma.projectsUncheckedUpdateManyWithoutSpacesInput> = z.object({
...
export const projectsUncheckedUpdateManyWithoutSpacesInputObjectZodSchema = z.object({
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  tags: z.union([z.lazy(() => projectsUpdatetagsInputObjectSchema), z.string().array()]).optional(),
  settings: z.union([NullableJsonNullValueInputSchema, jsonSchema]).optional(),
