...
export const strategy_impact_contractsCreateManyProjectsInputObjectSchema: z.ZodType<Prisma.strategy_impact_contractsCreateManyProjectsInput, Prisma.strategy_impact_contractsCreateManyProjectsInput> = z.object({
...
export const strategy_impact_contractsCreateManyProjectsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  strategy_node_id: z.string(),
  expected_direction: z.string().optional().nullable(),
