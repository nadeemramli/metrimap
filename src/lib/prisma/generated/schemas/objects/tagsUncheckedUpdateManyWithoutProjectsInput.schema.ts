...
export const tagsUncheckedUpdateManyWithoutProjectsInputObjectSchema: z.ZodType<Prisma.tagsUncheckedUpdateManyWithoutProjectsInput, Prisma.tagsUncheckedUpdateManyWithoutProjectsInput> = z.object({
...
export const tagsUncheckedUpdateManyWithoutProjectsInputObjectZodSchema = z.object({
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  color: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  description: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  created_by: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
