...
export const projectsUncheckedCreateWithoutMetric_cardsInputObjectSchema: z.ZodType<Prisma.projectsUncheckedCreateWithoutMetric_cardsInput, Prisma.projectsUncheckedCreateWithoutMetric_cardsInput> = z.object({
...
export const projectsUncheckedCreateWithoutMetric_cardsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  name: z.string(),
  description: z.string().optional().nullable(),
  tags: z.union([z.lazy(() => projectsCreatetagsInputObjectSchema), z.string().array()]).optional(),
