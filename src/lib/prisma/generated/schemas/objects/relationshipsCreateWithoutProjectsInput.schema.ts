...
export const relationshipsCreateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.relationshipsCreateWithoutProjectsInput, Prisma.relationshipsCreateWithoutProjectsInput> = z.object({
...
export const relationshipsCreateWithoutProjectsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  type: z.string(),
  confidence: z.string().optional(),
  weight: z.number().optional().nullable(),
