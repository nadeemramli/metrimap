...
export const strategy_impact_contractsUncheckedCreateWithoutMetric_cardsInputObjectSchema: z.ZodType<Prisma.strategy_impact_contractsUncheckedCreateWithoutMetric_cardsInput, Prisma.strategy_impact_contractsUncheckedCreateWithoutMetric_cardsInput> = z.object({
...
export const strategy_impact_contractsUncheckedCreateWithoutMetric_cardsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  project_id: z.string().optional().nullable(),
  expected_direction: z.string().optional().nullable(),
