...
export const metric_cardsCreateManyUsers_metric_cards_created_byTousersInputObjectSchema: z.ZodType<Prisma.metric_cardsCreateManyUsers_metric_cards_created_byTousersInput, Prisma.metric_cardsCreateManyUsers_metric_cards_created_byTousersInput> = z.object({
...
export const metric_cardsCreateManyUsers_metric_cards_created_byTousersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  project_id: z.string().optional().nullable(),
  title: z.string(),
  description: z.string().optional().nullable(),
