...
export const commentsScalarWhereWithAggregatesInputObjectSchema: z.ZodType<Prisma.commentsScalarWhereWithAggregatesInput, Prisma.commentsScalarWhereWithAggregatesInput> = z.object({
  ...
  author_id: z.union([z.lazy(() => StringNullableWithAggregatesFilterObjectSchema), z.string()]).optional().nullable(),
  ...
  parent_id: z.union([z.lazy(() => UuidNullableWithAggregatesFilterObjectSchema), z.string()]).optional().nullable()
}).strict();
