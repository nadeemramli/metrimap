...
export const evidence_itemsCreateWithoutProjectsInputObjectSchema: z.ZodType<Prisma.evidence_itemsCreateWithoutProjectsInput, Prisma.evidence_itemsCreateWithoutProjectsInput> = z.object({
...
export const evidence_itemsCreateWithoutProjectsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  title: z.string(),
  type: z.string(),
  date: z.union([z.date(), z.string().datetime()]),
