...
export const metric_cardsCreateWithoutNode_access_grantsInputObjectSchema: z.ZodType<Prisma.metric_cardsCreateWithoutNode_access_grantsInput, Prisma.metric_cardsCreateWithoutNode_access_grantsInput> = z.object({
...
export const metric_cardsCreateWithoutNode_access_grantsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  title: z.string(),
  description: z.string().optional().nullable(),
  category: z.string(),
