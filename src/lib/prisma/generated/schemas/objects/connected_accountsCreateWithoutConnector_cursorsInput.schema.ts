...
export const connected_accountsCreateWithoutConnector_cursorsInputObjectSchema: z.ZodType<Prisma.connected_accountsCreateWithoutConnector_cursorsInput, Prisma.connected_accountsCreateWithoutConnector_cursorsInput> = z.object({
...
export const connected_accountsCreateWithoutConnector_cursorsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  connector_id: z.string(),
