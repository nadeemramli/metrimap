...
import { groupsCreateNestedManyWithoutUsersInputObjectSchema } from './groupsCreateNestedManyWithoutUsersInput.schema';
...
export const usersCreateWithoutEvidence_items_evidence_items_created_byTousersInputObjectSchema: z.ZodType<Prisma.usersCreateWithoutEvidence_items_evidence_items_created_byTousersInput, Prisma.usersCreateWithoutEvidence_items_evidence_items_created_byTousersInput> = z.object({
  ...
  groups: z.lazy(() => groupsCreateNestedManyWithoutUsersInputObjectSchema).optional(),
...
export const usersCreateWithoutEvidence_items_evidence_items_created_byTousersInputObjectZodSchema = z.object({
  id: z.string().optional(),
  email: z.string(),
  name: z.string(),
  avatar_url: z.string().optional().nullable(),
