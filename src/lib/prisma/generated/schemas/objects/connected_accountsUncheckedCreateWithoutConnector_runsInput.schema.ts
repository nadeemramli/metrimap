...
export const connected_accountsUncheckedCreateWithoutConnector_runsInputObjectSchema: z.ZodType<Prisma.connected_accountsUncheckedCreateWithoutConnector_runsInput, Prisma.connected_accountsUncheckedCreateWithoutConnector_runsInput> = z.object({
...
export const connected_accountsUncheckedCreateWithoutConnector_runsInputObjectZodSchema = z.object({
  id: z.string().optional(),
  created_by: z.string().optional(),
  workspace_id: z.string().optional().nullable(),
  connector_id: z.string(),
