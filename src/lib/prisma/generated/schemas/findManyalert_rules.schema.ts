...
export const alert_rulesFindManySelectSchema: z.ZodType<Prisma.alert_rulesSelect, Prisma.alert_rulesSelect> = z.object({
...
export const alert_rulesFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    project_id: z.boolean().optional(),
    card_id: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const alert_rulesFindManySchema: z.ZodType<Prisma.alert_rulesFindManyArgs, Prisma.alert_rulesFindManyArgs> = z.object({ select: alert_rulesFindManySelectSchema.optional(), include: z.lazy(() => alert_rulesIncludeObjectSchema.optional()), orderBy: z.union([alert_rulesOrderByWithRelationInputObjectSchema, alert_rulesOrderByWithRelationInputObjectSchema.array()]).optional(), where: alert_rulesWhereInputObjectSchema.optional(), cursor: alert_rulesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([alert_rulesScalarFieldEnumSchema, alert_rulesScalarFieldEnumSchema.array()]).optional() }).strict();

export const alert_rulesFindManyZodSchema = z.object({ select: alert_rulesFindManySelectSchema.optional(), include: z.lazy(() => alert_rulesIncludeObjectSchema.optional()), orderBy: z.union([alert_rulesOrderByWithRelationInputObjectSchema, alert_rulesOrderByWithRelationInputObjectSchema.array()]).optional(), where: alert_rulesWhereInputObjectSchema.optional(), cursor: alert_rulesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([alert_rulesScalarFieldEnumSchema, alert_rulesScalarFieldEnumSchema.array()]).optional() }).strict();