...
export const alert_rulesDeleteOneSchema = z.object({ select: alert_rulesSelectObjectSchema.optional(), include: alert_rulesIncludeObjectSchema.optional(), where: alert_rulesWhereUniqueInputObjectSchema  })