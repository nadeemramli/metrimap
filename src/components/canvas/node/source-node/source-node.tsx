...
export const SourceNode = memo(({ data, selected }: NodeProps) => {
  ...
  return (
    <Card
      className={cn(
        "w-72 bg-card border-2 rounded-lg shadow-lg",
    ...
    >
      ...
      <CardContent>
        {Array.isArray(sample) && sample.length > 0 ? (
          ...
          <div className="h-20 flex items-center justify-center text-gray-500 border-2 border-dashed border-gray-200 rounded">
