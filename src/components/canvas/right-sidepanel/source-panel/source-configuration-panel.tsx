...
import { Database, FileSpreadsheet, Globe, TestTube, ArrowLeft, ArrowRight } from 'lucide-react'
...
export default function SourceConfigurationPanel({ 
  ...
  const generateMockDataForSource = (sourceType: string) => {
    ...
    switch (sourceType) {
      case 'warehouse':
        return [
          { user_id: 1, event_name: 'page_view', timestamp: '2024-01-01 10:00:00', value: 1 },
          { user_id: 2, event_name: 'click', timestamp: '2024-01-01 10:05:00', value: 1 },
          { user_id: 1, event_name: 'purchase', timestamp: '2024-01-01 10:10:00', value: 99.99 }
        ]
      case 'csv':
        return [
      ...
      case 'sheets':
        return [
          ...
          { product: 'Widget A', sales: 175, revenue: 17500, month: 'February' }
        ]
      default:
        return []
    }
        ...
        return (
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select value={config.delimiter || ','} onValueChange={(value) => setConfig({...config, delimiter: value})}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
  ...
  const getSourceIcon = (sourceType: string) => {
    switch (sourceType) {
      ...
      case 'sheets': return <Globe className="h-5 w-5" />
      case 'api': return <TestTube className="h-5 w-5" />
    ...
    <div className="max-w-2xl mx-auto p-6">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600">Set up your connection to retrieve data</p>
        </div>
      </div>
      ...
      {!selectedSource ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            { id: 'warehouse', name: 'Data Warehouse', desc: 'PostgreSQL, MySQL, etc.' },
            { id: 'csv', name: 'CSV File', desc: 'Upload or select CSV files' },
            { id: 'sheets', name: 'Google Sheets', desc: 'Connect to Google Sheets' },
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="capitalize">{selectedSource} Configuration</CardTitle>
              <Badge variant="outline" onClick={() => setSelectedSource('')} className="cursor-pointer">
                Change
              </Badge>
            </div>
          </CardHeader>
