      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl w-full">
        ...
        >
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">Basic Transformations</h3>
            <p className="text-gray-600 mb-4">
              Use visual tools and pre-built operations to transform your data without writing code.
            </p>
            <div className="space-y-2 mb-4">
              <Badge variant="secondary" className="mr-2">Filter Rows</Badge>
              <Badge variant="secondary" className="mr-2">Group By</Badge>
              <Badge variant="secondary" className="mr-2">Sort</Badge>
              <Badge variant="secondary" className="mr-2">Join Tables</Badge>
              <Badge variant="secondary" className="mr-2">Aggregate</Badge>
            </div>
        ...
        >
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">Advanced Transformations</h3>
            <p className="text-gray-600 mb-4">
              Write custom SQL queries or Python scripts for complex data transformations and analysis.
            </p>
            <div className="space-y-2 mb-4">
              <Badge variant="secondary" className="mr-2">SQL Queries</Badge>
              <Badge variant="secondary" className="mr-2">Python Scripts</Badge>
              <Badge variant="secondary" className="mr-2">Custom Functions</Badge>
              <Badge variant="secondary" className="mr-2">Complex Logic</Badge>
              <Badge variant="secondary" className="mr-2">ML Operations</Badge>
            </div>
