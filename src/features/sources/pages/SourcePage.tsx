...
import DataSourceDialog from '@/features/sources/components/dialogs/DataSourceDialog';
import ExportDialog, {
  type ExportOptions,
} from '@/features/sources/components/dialogs/ExportDialog';
import GovernancePolicyDialog from '@/features/sources/components/dialogs/GovernancePolicyDialog';
import MonitoringSettingsDialog, {
  type MonitoringSettings,
} from '@/features/sources/components/dialogs/MonitoringSettingsDialog';
...
export default function SourcePage() {
  ...
  // removed unused availableSystems
  ...
  // removed unused handleMonitoringSettings

  // removed unused handleAddMonitor

  // Dialog handlers
  const handleExportData = async (options: ExportOptions) => {
    try {
      const exportedData = await exportData('all');
      ...
      link.href = url;
      link.download = `metrimap-all-${new Date().toISOString().split('T')[0]}.${options.format ?? 'json'}`;
